...
x892017_g_MonsterId = 13556    ---npc¹ÖÎïID
x892017_g_CreateId = 13492     ----´´½¨µÄ¹ÖÎïID
x892017_g_posX = 41            ----´´½¨¹ÖÎï×ø±êx
x892017_g_posY = 35            ----´´½¨¹ÖÎï×ø±êy
x892017_g_AIScript = 253       ----´´½¨¹ÖÎï¼¼ÄÜ¶ÔÓ¦ÎÄ¼þID
x892017_g_Title = "Thiên Cô Tinh"       ----´´½¨¹ÖÎï³ÆºÅ
...
function x892017_OnDefaultEvent( sceneId, selfId, targetId )
	BeginEvent(sceneId)
		...
		AddNumText( sceneId, x892017_g_scriptId, "#c00ff00Quyªt chiªn L² Chí Sinh", 6, 200)
	EndEvent(sceneId)
...
function x892017_OnEventRequest( sceneId, selfId, targetId, eventId )
	...
	CallScriptFunction( x892017_g_scriptId, "TipAllHuman", sceneId, "B¡t ð¥u chiªn ð¤u." )
	...
	local MstId = LuaFnCreateMonster(sceneId, x892017_g_CreateId, posX, posY, 27, AIScript, 501000);
