...
x892021_g_MonsterId = 13561    ---npc¹ÖÎïID
x892021_g_CreateId = 13537     ----´´½¨µÄ¹ÖÎïID
x892021_g_posX = 35            ----´´½¨¹ÖÎï×ø±êx
x892021_g_posY = 23            ----´´½¨¹ÖÎï×ø±êy
x892021_g_AIScript = 257       ----´´½¨¹ÖÎï¼¼ÄÜ¶ÔÓ¦ÎÄ¼þID
x892021_g_Title = "Thiên Thß½ng Tinh"       ----´´½¨¹ÖÎï³ÆºÅ
...
function x892021_OnDefaultEvent( sceneId, selfId, targetId )
	BeginEvent(sceneId)
		...
		AddNumText( sceneId, x892021_g_scriptId, "#c00ff00Quyªt chiªn Võ Tòng", 6, 200)
	EndEvent(sceneId)
...
function x892021_OnEventRequest( sceneId, selfId, targetId, eventId )
	...
	CallScriptFunction( x892021_g_scriptId, "TipAllHuman", sceneId, "B¡t ð¥u chiªn ð¤u." )
	...
	local MstId = LuaFnCreateMonster(sceneId, x892021_g_CreateId, posX, posY, 27, AIScript, 501000);
