...
x892014_g_MonsterId = 13554    ---npc¹ÖÎïID
x892014_g_CreateId = 13474     ----´´½¨µÄ¹ÖÎïID
x892014_g_posX = 28            ----´´½¨¹ÖÎï×ø±êx
x892014_g_posY = 42            ----´´½¨¹ÖÎï×ø±êy
x892014_g_AIScript = 253       ----´´½¨¹ÖÎï¼¼ÄÜ¶ÔÓ¦ÎÄ¼þID
x892014_g_Title = "Thiên Nhãn Tinh"       ----´´½¨¹ÖÎï³ÆºÅ
...
function x892014_OnDefaultEvent( sceneId, selfId, targetId )
	BeginEvent(sceneId)
		...
		AddNumText( sceneId, x892014_g_scriptId, "#c00ff00Quyªt chiªn Công Tôn Thánh", 6, 200)
	EndEvent(sceneId)
...
--ÊÂ¼þÁÐ±íÑ¡ÖÐÒ»Ïî
--**********************************
function x892014_OnEventRequest( sceneId, selfId, targetId, eventId )
	...
	for i=0, nCount-1  do
		...
		if MosDataID == x892014_g_CreateId then
               	        BeginEvent( sceneId ) 
	...
	CallScriptFunction( x892014_g_scriptId, "TipAllHuman", sceneId, "B¡t ð¥u chiªn ð¤u." )
	local nMonsterNum = GetMonsterCount(sceneId)
	local Monsters = x892014_g_MonsterId
	...
	local posX = x892014_g_posX
	local posY = x892014_g_posY
	local AIScript = x892014_g_AIScript
	local Title = x892014_g_Title

	local MstId = LuaFnCreateMonster(sceneId, x892014_g_CreateId, posX, posY, 27, AIScript, 501000);
...
--ÌáÊ¾ËùÓÐ¸±±¾ÄÚÍæ¼Ò....
--**********************************
function x892014_TipAllHuman( sceneId, Str )
