...
x892016_g_MonsterId = 13550    ---npc¹ÖÎïID
x892016_g_CreateId = 13438     ----´´½¨µÄ¹ÖÎïID
x892016_g_posX = 41            ----´´½¨¹ÖÎï×ø±êx
x892016_g_posY = 42            ----´´½¨¹ÖÎï×ø±êy
x892016_g_AIScript = 256       ----´´½¨¹ÖÎï¼¼ÄÜ¶ÔÓ¦ÎÄ¼þID
x892016_g_Title = "Thiên Khôi Tinh"       ----´´½¨¹ÖÎï³ÆºÅ
...
function x892016_OnDefaultEvent( sceneId, selfId, targetId )
	BeginEvent(sceneId)
		...
		AddNumText( sceneId, x892016_g_scriptId, "#c00ff00Quyªt chiªn T¯ng Khß½ng", 6, 200)
	EndEvent(sceneId)
...
function x892016_OnEventRequest( sceneId, selfId, targetId, eventId )
	...
	CallScriptFunction( x892016_g_scriptId, "TipAllHuman", sceneId, "B¡t ð¥u chiªn ð¤u." )
	...
	local MstId = LuaFnCreateMonster(sceneId, x892016_g_CreateId, posX, posY, 27, AIScript, 501000);
