...
x892018_g_MonsterId = 13559    ---npc¹ÖÎïID
x892018_g_CreateId = 13519     ----´´½¨µÄ¹ÖÎïID
x892018_g_posX = 41            ----´´½¨¹ÖÎï×ø±êx
x892018_g_posY = 29            ----´´½¨¹ÖÎï×ø±êy
x892018_g_AIScript = 254       ----´´½¨¹ÖÎï¼¼ÄÜ¶ÔÓ¦ÎÄ¼þID
x892018_g_Title = "Thiên Mãnh Tinh"       ----´´½¨¹ÖÎï³ÆºÅ
...
function x892018_OnDefaultEvent( sceneId, selfId, targetId )
	BeginEvent(sceneId)
		...
		AddNumText( sceneId, x892018_g_scriptId, "#c00ff00Quyªt chiªn T¥n Minh", 6, 200)
	EndEvent(sceneId)
...
function x892018_OnEventRequest( sceneId, selfId, targetId, eventId )
	...
	CallScriptFunction( x892018_g_scriptId, "TipAllHuman", sceneId, "B¡t ð¥u chiªn ð¤u." )
