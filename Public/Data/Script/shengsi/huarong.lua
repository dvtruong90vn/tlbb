...
x892013_g_MonsterId = 13560    ---npc¹ÖÎïID
x892013_g_CreateId = 13528     ----´´½¨µÄ¹ÖÎïID
x892013_g_posX = 21            ----´´½¨¹ÖÎï×ø±êx
x892013_g_posY = 42            ----´´½¨¹ÖÎï×ø±êy
x892013_g_AIScript = 255       ----´´½¨¹ÖÎï¼¼ÄÜ¶ÔÓ¦ÎÄ¼þID
x892013_g_Title = "Thiên Anh Tinh"       ----´´½¨¹ÖÎï³ÆºÅ
...
function x892013_OnDefaultEvent( sceneId, selfId, targetId )
	BeginEvent(sceneId)
		...
		AddNumText( sceneId, x892013_g_scriptId, "#c00ff00Quyªt chiªn Hoa Dung", 6, 200)
	EndEvent(sceneId)
