...
x892019_g_MonsterId = 13558    ---npc¹ÖÎïID
x892019_g_CreateId = 13510     ----´´½¨µÄ¹ÖÎïID
x892019_g_posX = 41            ----´´½¨¹ÖÎï×ø±êx
x892019_g_posY = 23            ----´´½¨¹ÖÎï×ø±êy
x892019_g_AIScript = 258       ----´´½¨¹ÖÎï¼¼ÄÜ¶ÔÓ¦ÎÄ¼þID
x892019_g_Title = "Thiên Hùng Tinh"       ----´´½¨¹ÖÎï³ÆºÅ
...
function x892019_OnDefaultEvent( sceneId, selfId, targetId )
	BeginEvent(sceneId)
		...
		AddNumText( sceneId, x892019_g_scriptId, "#c00ff00Quyªt chiªn Lâm Sung", 6, 200)
	EndEvent(sceneId)
...
function x892019_OnEventRequest( sceneId, selfId, targetId, eventId )
	...
	CallScriptFunction( x892019_g_scriptId, "TipAllHuman", sceneId, "B¡t ð¥u chiªn ð¤u." )
