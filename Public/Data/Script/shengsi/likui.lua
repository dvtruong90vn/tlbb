...
x892012_g_MonsterId = 13551    ---npc¹ÖÎïID
x892012_g_CreateId = 13447     ----´´½¨µÄ¹ÖÎïID
x892012_g_posX = 21            ----´´½¨¹ÖÎï×ø±êx
x892012_g_posY = 35            ----´´½¨¹ÖÎï×ø±êy
x892012_g_AIScript = 257       ----´´½¨¹ÖÎï¼¼ÄÜ¶ÔÓ¦ÎÄ¼þID
x892012_g_Title = "Thiên Sát Tinh"       ----´´½¨¹ÖÎï³ÆºÅ
...
function x892012_OnDefaultEvent( sceneId, selfId, targetId )
	BeginEvent(sceneId)
		...
		AddNumText( sceneId, x892012_g_scriptId, "#c00ff00Quyªt chiªn Lý Khôi", 6, 200)
	EndEvent(sceneId)
...
--ÊÂ¼þÁÐ±íÑ¡ÖÐÒ»Ïî
--**********************************
function x892012_OnEventRequest( sceneId, selfId, targetId, eventId )
	...
	for i=0, nCount-1  do
		...
		if MosDataID == x892012_g_CreateId then
               	        BeginEvent( sceneId ) 
	...
	CallScriptFunction( x892012_g_scriptId, "TipAllHuman", sceneId, "B¡t ð¥u chiªn ð¤u." )
	local nMonsterNum = GetMonsterCount(sceneId)
	local Monsters = x892012_g_MonsterId
	...
	local posX = x892012_g_posX
	local posY = x892012_g_posY
	local AIScript = x892012_g_AIScript
	local Title = x892012_g_Title

	local MstId = LuaFnCreateMonster(sceneId, x892012_g_CreateId, posX, posY, 27, AIScript, 501000);
...
--ÌáÊ¾ËùÓÐ¸±±¾ÄÚÍæ¼Ò....
--**********************************
function x892012_TipAllHuman( sceneId, Str )
