--********************--
x887787_g_scriptId = 887787
--********************--

--**********************************--
--*        On Default Event        *--
--**********************************--
function x887787_OnDefaultEvent(sceneId,selfId,bagIndex)
...
--**********************************--
function x887787_IsSkillLikeScript(sceneId,selfId)
...
--*         Cancel Impacts         *--
--**********************************--
function x887787_CancelImpacts(sceneId,selfId)
...
--*       On Condition Check       *--
--**********************************--
function x887787_OnConditionCheck(sceneId,selfId)
...
--*           On Deplete           *--
--**********************************--
function x887787_OnDeplete(sceneId,selfId)
...
--*        On Activate Once        *--
--**********************************--
function x887787_OnActivateOnce(sceneId,selfId)
	--********************--
	local WHExpLevel = {}
		WHExpLevel[1] = {1500}
		WHExpLevel[2] = {1510}
	...
	if szAuthor ~= nil then
		...
		LuaFnSetItemCreator(sceneId,selfId,0,"00450004500100000000000000000")
		LuaFnSendSpecificImpactToUnit(sceneId,selfId,selfId,selfId,18,0)
		BeginEvent(sceneId)
			AddText(sceneId,"Võ h°n ðã lên c¤p 4")
		EndEvent(sceneId)
		DispatchMissionTips(sceneId,selfId)
	end
	--********************--
...
--*        On Default Event        *--
--**********************************--
function x887787_OnActivateEachTick(sceneId,selfId)
