--********************--
x887785_g_scriptId = 887785
--********************--

--**********************************--
--*        On Default Event        *--
--**********************************--
function x887785_OnDefaultEvent(sceneId,selfId,bagIndex)
...
--**********************************--
function x887785_IsSkillLikeScript(sceneId,selfId)
...
--*         Cancel Impacts         *--
--**********************************--
function x887785_CancelImpacts(sceneId,selfId)
...
--*       On Condition Check       *--
--**********************************--
function x887785_OnConditionCheck(sceneId,selfId)
...
--*           On Deplete           *--
--**********************************--
function x887785_OnDeplete(sceneId,selfId)
...
--*        On Activate Once        *--
--**********************************--
function x887785_OnActivateOnce(sceneId,selfId)
	--********************--
	local WHExpLevel = {}
		WHExpLevel[1] = {1500}
		WHExpLevel[2] = {1510}
	...
	if szAuthor ~= nil then
		...
		LuaFnSetItemCreator(sceneId,selfId,0,"01500002500100000000000000000")
		LuaFnSendSpecificImpactToUnit(sceneId,selfId,selfId,selfId,18,0)
		BeginEvent(sceneId)
			AddText(sceneId,"Võ h°n ðã lên c¤p 2")
		EndEvent(sceneId)
		DispatchMissionTips(sceneId,selfId)
	end
	--********************--
...
--*        On Default Event        *--
--**********************************--
function x887785_OnActivateEachTick(sceneId,selfId)
