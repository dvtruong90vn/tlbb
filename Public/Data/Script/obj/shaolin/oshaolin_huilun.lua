...
function x009009_OnDefaultEvent( sceneId, selfId,targetId )
    ...
    CallScriptFunction( x009009_g_xuanWuDaoId, "OnEnumerate",sceneId, selfId, targetId )
		...
		AddNumText(sceneId,x009009_g_ScriptId,"#G#bÐßa ta ði các môn phái khác",9,11)
		
		-- ÎÒÔõÑù²ÅÄÜÈ¥¶Ø»ÍºÍáÔÉ½
		AddNumText( sceneId, x009009_g_ScriptId, "Làm thª nào ð¬ ðªn Ðôn Hoàng và Tung S½n ?", 11, 2000 )
	EndEvent(sceneId)
