...
x000154_g_MenpaiWantHonour = 5000 --???¨¦¨º¡À¡Á¡ãD¨¨¨°a¦Ì?¨¨¨´¨®t
x000154_g_MenpaiGoodsIndex={10124142,10124143,10124144,10124145,10124146,
														10124147,10124148,10124149,10124150}

x000154_g_WantHonour = 100 --D¨¨¨°a¦Ì?¨¨¨´¨®t
x000154_g_GiveBanggong = 50 --??¦Ì?¡ã?1¡À

x000154_g_BuyLuoyangMoney = 10000000 --1000?e

x000154_g_LuoyangOwnerIndex = 53 --????3?1¨¦¨º?¡ã??¨¦ID?¨²GlobalData¨¤???¦Ì??¡Â¨°y
x000154_g_BaseGuildIndex = 10000 --¡ã??¨¦ID¦Ì??¨´¡ä??¦Ì¡ê?¨°¨°?aGlobalData¨¤???3?¨º??¦Ì¨º?0¡ê???0¨º?o?¡¤¡§¡ã??¨¦ID¡ê?¨°¨°¡ä??T¡¤¡§?D??¨º?¡¤?¨®D¨¨?¨°??-?¨°¨¢??¡ê¡ã??¨¦ID?¨®¨¦?¨°????¨´¡ä??¦Ì¡ê??a?¨´?¨¦¨°?¨®?0¨¤¡ä?D??¨º?¡¤?1o?¨°

--3?o??¡À¨¤?
x000154_g_PrizeTitle = {AwardPos = 18, SetPos = 42, Index = 255}--?¡À¨¤?¦Ì??¡Â¨°y(??¡À?o¡¥¨ºy?D¦Ì?case?¡Â¨°y)¡ê?¨¦¨¨??????¦Ì??¡Â¨°y(_TITLE???¨´?D¦Ì??¦Ì)¡ê?3?o??¡Â¨°y(CharTitle.txt¡À¨ª?D¦Ì??¡Â¨°y)

x000154_g_LuoyangCityMoneyJZ = 200000 --¨¢¨¬¨¨?¦Ì?????3?¨ºD1¡è¡Á¨º 20?e??¡Á¨®
...
--			else
--				x000154_NotifyFailBox(sceneId, selfId, targetId, "    ??3y?e??¨º¡ì¡ã¨¹¡ê?")
--			end
--		end
...
--		end
	...
	for i, findId in x000154_g_eventList do
		if eventId == findId then
			CallScriptFunction( eventId, "OnDefaultEvent",sceneId, selfId, targetId, GetNumText() )	--GetNumText()¨º?addnumtext?D¡Á?o¨®¦Ì?¡À?¨¢?
			return
		end
	end
...
function x000154_CheckGetMoneyJZ( sceneId, selfId, targetId )
	...
	--¨¢¨¬¨¨?1¡è¡Á¨º¦Ì?¨º¡À??¡¤??¡ì ?¨¹¨¨?¦Ì?0¡êo00¦Ì?24¡êo00
