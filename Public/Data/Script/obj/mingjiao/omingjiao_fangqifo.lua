...
function x011003_OnDefaultEvent( sceneId, selfId,targetId )
    ...
    CallScriptFunction( x011003_g_xuanWuDaoId, "OnEnumerate",sceneId, selfId, targetId )
		...
		AddNumText(sceneId,x011003_g_scriptId,"#G#bÐßa ta ði các môn phái khác",9,11)

		-- ÎÒÔõÑù²ÅÄÜÈ¥¶Ø»ÍºÍáÔÉ½
		AddNumText( sceneId, x011003_g_scriptId, "Làm thª nào ð¬ ðªn Ðôn Hoàng và Tung S½n ?", 11, 2000 )
	EndEvent(sceneId)
