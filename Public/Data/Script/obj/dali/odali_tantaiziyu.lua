...
function x002046_UpdateEventList( sceneId, selfId,targetId )
	...
	elseif Menpai == 8 then
		AddText(sceneId,"  "..PlayerSex..", võ công cüa ngß½i tiªn bµ th§t nhanh. Phái Tiêu Dao chï làm không nói. Xem ra ngß½i quä là thiên tß thông minh th§t. Ha ha....")
	else
		AddText(sceneId,"Lâu r°i không g£p ngß½i. Tiêu Dao ta c¥m kÏ thi h÷a món nào cûng giöi. Th§t tiªc ngß½i không ðßþc lînh ngµ nhæng tinh hoa b±n phái...")
	end
	
	if	GetLevel( sceneId, selfId)<=10	then
		AddNumText(sceneId,x002046_g_scriptId,"Ði Lång Ba Ðµng mµt chuyªn",9,0)
	end
