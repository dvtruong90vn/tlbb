...
function x890075_OnDefaultEvent( sceneId, selfId, targetId )
	...
	BeginEvent(sceneId)
		AddText( sceneId, "Bän nhân Ðinh Xuân Thu - Trß·ng môn nhân phái Tinh Túc. Mu¯n khiêu chiªn v¾i ta, hãy ðánh bÕi các ð¯i thü khác trß¾c. C¦n th§n nÕp mÕng vô ích!." )
