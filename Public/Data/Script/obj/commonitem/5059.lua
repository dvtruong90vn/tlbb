...
--脚本号
 x335054_g_scriptId = 335054 --临时写这个,真正用的时候一定要改.
...
--注：两个骑术会一个就可以骑了
 x335054_g_Equitation1 = 1089 --需要的骑术
 x335054_g_Equitation2 = -1 --需要的骑术
--效果的ID
 x335054_g_Impact1 = 5731 --临时写这个
 x335054_g_Impact2 = -1 --不用
