...
function x002958_OnDefaultEvent( sceneId, selfId, targetId )
	...
	BeginEvent( sceneId )
		if GetLevel( sceneId, selfId ) >= 10 then
			...
			AddNumText( sceneId, x002958_g_ScriptId, "#gf19fcc通天塔塔顶 → [顶极材料]", 9, 1002 )
			AddNumText( sceneId, x002958_g_ScriptId, "#通天塔三层 #B→ [升级地图]", 9, 1003 )
			AddNumText( sceneId, x002958_g_ScriptId, "#通天塔二层 #B→ [升级地图]", 9, 1006 )
			AddNumText( sceneId, x002958_g_ScriptId, "#通天塔一层 #B→ [升级地图]", 9, 1007 )
			AddNumText( sceneId, x002958_g_ScriptId, "#通天塔地宫 #B→ [升级地图]", 9, 1008 )
			AddNumText( sceneId, x002958_g_ScriptId, "#ccc33cc秦王地宫四层 #ccc33cc→ [新手地图]", 9, 1015 )
			AddNumText( sceneId, x002958_g_ScriptId, "#G钧天王陵 → [属性时装坐骑]", 9, 1013 )
			AddNumText( sceneId, x002958_g_ScriptId, "#cFF0000终极BOOS地图 →#cFF0000 [刷重楼材料]", 9, 1012 )
			--AddNumText( sceneId, x002958_g_ScriptId, "#G钧天王陵 → [兑换时装坐骑]", 9, 1013 )
			AddNumText( sceneId, x002958_g_ScriptId, "#cFF0000终极BOOS群地图 →#cFF0000 [重楼链]", 9, 1014 )
			AddNumText( sceneId, x002958_g_ScriptId, "#cFF0000BOOS群地图 →#cFF0000 [龙纹材料]", 9, 1016 )
