...
x402263_g_BOSSList =
{
	...
	["WuLaoDa_NPC"]				= { DataID=9550, Title="#c00ff00VÕn Tiên Chi Thü", posX=117, posY=49, Dir=11, BaseAI=3, AIScript=0, ScriptID=402272 },
	["WuLaoDaLoss_NPC"]		= { DataID=9551, Title="#c00ff00VÕn Tiên Chi Thü", posX=0, posY=0, Dir=0, BaseAI=3, AIScript=0, ScriptID=402275 },
	["WuLaoDa_BOSS"]			= { DataID=9543, Title="#c00ff00VÕn Tiên Chi Thü", posX=117, posY=49, Dir=11, BaseAI=27, AIScript=0, ScriptID=402266 },

	["ZhuoBuFan_BOSS"]		= { DataID=9544, Title="#c00ff00Kiªm Th¥n", posX=121, posY=31, Dir=0, BaseAI=27, AIScript=0, ScriptID=402267 },
	["BuPingDaoRen_BOSS"]	= { DataID=9545, Title="#c00ff00Giao Vß½ng", posX=129, posY=31, Dir=0, BaseAI=27, AIScript=261, ScriptID=402268 },
	...
	["LiQiuShui_BOSS"]		= { DataID=9546, Title="#c00ff00Tây HÕ Hoàng Phi", posX=125, posY=36, Dir=11, BaseAI=27, AIScript=0, ScriptID=402269 },
}
...
function x402263_OnEnumerate( sceneId, selfId, targetId )
	...
	AddNumText( sceneId, x402263_g_ScriptId, "TØ chiªn Phiêu Diêu Phong", 10, 1 )
...
function x402263_CheckCanEnter( sceneId, selfId, targetId )
	...
	if nHumanNum > 0 then
		...
		msg = msg .. Humanlist[nHumanNum-1] .. " c¤p ðµ còn th¤p, không th¬ tham gia."
		return 0, msg
	...
	if nHumanNum > 0 then
		...
		msg = msg .. Humanlist[nHumanNum-1] .. " ngày hôm nay ðã 3 l¥n khiêu chiªn Phiêu Diêu Phong."
		return 0, msg
