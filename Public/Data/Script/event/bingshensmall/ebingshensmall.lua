...
x895063_g_LimitMembers = 1					-- ¿ÉÒÔ½ø¸±±¾µÄ×îÐ¡¶ÓÎéÈËÊý
...
x895063_g_BOSSList =
{
	["XiaoYiFeng_NPC"]				= { DataID=15006, Title="T§t Nhß Phong", posX=51, posY=53, Dir=27, BaseAI=3, AIScript=0, ScriptID=895070 },
	["XiaoYiFeng_BOSS"]				= { DataID=15010, Title="T§t Nhß Phong", posX=51, posY=53, Dir=27, BaseAI=27, AIScript=301, ScriptID=895064 },
	...
	["XiaoRuJun_NPC"]		= { DataID=15026, Title="T× Nhß Lâm", posX=173, posY=36, Dir=0, BaseAI=3, AIScript=0, ScriptID=895071 },
	["XiaoRuJun_BOSS"]		= { DataID=15030, Title="T× Nhß Lâm", posX=173, posY=36, Dir=0, BaseAI=27, AIScript=0, ScriptID=895065 },
	["XiaoRuWei_NPC"]		= { DataID=15031, Title="T× Nhß Lâm", posX=173, posY=100, Dir=0, BaseAI=3, AIScript=0, ScriptID=895068 },
	["XiaoRuWei_BOSS"]		= { DataID=15035, Title="T× Nhß Lâm", posX=173, posY=100, Dir=0, BaseAI=27, AIScript=0, ScriptID=895067 },

	["ZhuBai_BOSS"]			= { DataID=15040, Title="NgoÕi Công Phòng Ngñ", posX=169, posY=36, Dir=0, BaseAI=28, AIScript=0, ScriptID=895080 },
	["ZhuHong_BOSS"]			= { DataID=15060, Title="Kháng Höa", posX=173, posY=32, Dir=0, BaseAI=28, AIScript=0, ScriptID=895083 },
	["ZhuHuang_BOSS"]			= { DataID=15050, Title="Kháng Huy«n", posX=177, posY=36, Dir=0, BaseAI=28, AIScript=0, ScriptID=895082 },
	["ZhuLan_BOSS"]			= { DataID=15065, Title="Kháng Bång", posX=176, posY=39, Dir=0, BaseAI=28, AIScript=0, ScriptID=895084 },
	["ZhuLv_BOSS"]			= { DataID=15055, Title="Kháng Ðµc", posX=170, posY=33, Dir=0, BaseAI=28, AIScript=0, ScriptID=895085 },
	["ZhuZi_BOSS"]			= { DataID=15045, Title="Nµi Công Phòng Ngñ", posX=173, posY=38, Dir=0, BaseAI=28, AIScript=0, ScriptID=895081 },

	["Bai_BOSS"]			= { DataID=15140, Title="NgoÕi Công Phòng Ngñ", posX=169, posY=100, Dir=0, BaseAI=28, AIScript=0, ScriptID=895086 },
	["Hong_BOSS"]			= { DataID=15160, Title="Kháng Höa", posX=173, posY=97, Dir=0, BaseAI=28, AIScript=0, ScriptID=895089 },
	["Huang_BOSS"]			= { DataID=15150, Title="Kháng Huy«n", posX=177, posY=98, Dir=0, BaseAI=28, AIScript=0, ScriptID=895088 },
	["Lan_BOSS"]			= { DataID=15165, Title="±ù¿¹", posX=176, posY=101, Dir=0, BaseAI=28, AIScript=0, ScriptID=895090 },
	["Lv_BOSS"]			= { DataID=15155, Title="¶¾¿¹", posX=175, posY=104, Dir=0, BaseAI=28, AIScript=0, ScriptID=895091 },
	["Zi_BOSS"]			= { DataID=15145, Title="Nµi Công Phòng Ngñ", posX=173, posY=101, Dir=0, BaseAI=28, AIScript=0, ScriptID=895087 },

	["YeLvYan_NPC"]				= { DataID=15071, Title="Xâm Lßþc Nhß Höa", posX=192, posY=195, Dir=27, BaseAI=3, AIScript=0, ScriptID=895072 },
	["YeLvYanLoss_NPC"]		= { DataID=14216, Title="", posX=117, posY=49, Dir=0, BaseAI=3, AIScript=0, ScriptID=895075 },
	["YeLvYan_BOSS"]			= { DataID=15075, Title="Xâm Lßþc Nhß Höa", posX=192, posY=195, Dir=27, BaseAI=27, AIScript=0, ScriptID=895066 },
	...
	["LiFan_NPC"]				= { DataID=15086, Title="B¤t Ðµng Nhß S½n", posX=52, posY=203, Dir=27, BaseAI=3, AIScript=0, ScriptID=895075 },
	["YeLvLian_BOSS"]		= { DataID=15090, Title="B¤t Ðµng Nhß S½n", posX=52, posY=203, Dir=27, BaseAI=27, AIScript=0, ScriptID=895069 },
...
function x895063_OnEnumerate( sceneId, selfId, targetId )
	...
	AddNumText( sceneId, x894063_g_ScriptId, "#cFF0000S½ chiªn Binh Thánh KÏ Tr§n", 10, 1 )
...
function x895063_OnCopySceneReady( sceneId, destsceneId )
	...
	for	i=0,nearteammembercount-1 do
		...
		if lastDayCount >= 3 then
			BeginEvent( sceneId )
				AddText( sceneId, "Các hÕ ðã tham gia phø bän này 3 l¥n trong ngày r°i!" )
			EndEvent( sceneId )
			DispatchEventList( sceneId, selfId, targetId )
		return
		end
...
function x895063_CheckHaveBOSS( sceneId )
	...
	if nBossNum > 0 then
		...
		msg = msg .. BossList[nBossNum-1] .. " chiªn ð¤u sinh tØ tÕi Binh Thánh KÏ Tr§n"
		return 1, msg
	end
