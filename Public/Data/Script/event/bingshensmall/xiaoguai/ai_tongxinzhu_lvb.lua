...
x895091_MyName			= "Tiêu Nhß Quân"	--×Ô¼ºµÄÃû×Ö....
...
function x895091_OnDie( sceneId, selfId, killerId )
	...
	CallScriptFunction( x894091_g_FuBenScriptId, "TipAllHuman", sceneId, "Tr¥n Dûng ÐÕo Nhân: #c2ebeff"..GetName( sceneId, selfId ).."  cüa Tiêu Nhß Quân ðã b¸ phá hüy!" )
