...
x895081_MyName			= "Tiêu Nhß Quân"	--×Ô¼ºµÄÃû×Ö....
...
function x895081_OnDie( sceneId, selfId, killerId )
	...
	CallScriptFunction( x894081_g_FuBenScriptId, "TipAllHuman", sceneId, "Tr¥n Dûng ÐÕo Nhân: #c2ebeff"..GetName( sceneId, selfId ).." cüa Tiêu Nhß Quân ðã b¸ phá hüy!" )
