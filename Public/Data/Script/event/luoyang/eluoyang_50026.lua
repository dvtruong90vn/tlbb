...
x250026_g_MissionTarget="Giúp Vân Hàm Nhi tìm ðßþc 1 con Kh±ng Tß¾c."		--ÈÎÎñÄ¿±ê
x250026_g_ContinueInfo="Các hÕ b¡t ðßþc Kh±ng Tß¾c ch½a?"		--Î´Nhi®m vø hoàn thành!µÄnpc¶Ô»°
x250026_g_MissionComplete="Làm t¯t l¡m."					--Nhi®m vø hoàn thành!npcËµ»°µÄ»°
	...
	if indexpet == 255 then --Ë÷ÒýÖµ·µ»Ø255±íÊ¾¿Õ£¬Ã»Ìá½»ÕäÊÞ
		...
		if petdataid == x250026_g_PetDataID then
			--½±Àø½ðÇ®²¢ÌáÊ¾
				...
				BeginEvent(sceneId)
					AddText(sceneId,"Nhi®m vø hoàn thành, t£ng cho các hÕ #{_MONEY"..x250026_g_MoneyBonus.."}")
				EndEvent(sceneId)
