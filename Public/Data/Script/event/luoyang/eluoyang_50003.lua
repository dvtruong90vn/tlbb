...
x250003_g_MissionInfo="Ti¬u thß nhà tôi mu¯n 1 con Thö."  --ÈÎÎñÃèÊö
x250003_g_MissionTarget="Giúp Vân Hàm Nhi tìm ğßşc 1 con Thö."		--ÈÎÎñÄ¿±ê
x250003_g_ContinueInfo="Các hÕ b¡t ğßşc Thö ch½a?"		--Î´Nhi®m vø hoàn thành!µÄnpc¶Ô»°
x250003_g_MissionComplete="Làm t¯t l¡m."					--Nhi®m vø hoàn thành!npcËµ»°µÄ»°
...
function x250003_OnAccept( sceneId, selfId )
  ...
  if( 0 == x250003_GetTimePass( sceneId, selfId ) ) then      
      --Msg2Player(  sceneId, selfId,"#YTh¶i gian bö nhi®m vø không ğü 15 phút, không th¬ tiªp nh§n tiªp!",MSG2PLAYER_PARA )	--ÁÄÌì´°¿ÚÌáÊ¾
	...
	--¼ì²âÍæ¼ÒÉíÉÏµÄµÀ¾ßÊÇ·ñÒÑ¾­Âú×ãÍê³ÉÌõ¼ş£¬Èç¹ûÒÑ¾­Âú×ã£¬Ôò°ÑNhi®m vø hoàn thành!µÄ±äÁ¿ÖÃÎª1
...
function x250003_OnAbandon( sceneId, selfId )
    ...
    --Msg2Player(  sceneId, selfId,"#YÄã·ÅÆúÁËB¡t trân thúÈÎÎñ£¬15·ÖÖÓÖ®ÄÚÄã½«ÎŞ·¨ÔÙ´Î½ÓÊÜ´ËÈÎÎñ",MSG2PLAYER_PARA )	--ÁÄÌì´°¿ÚÌáÊ¾
	...
	if indexpet == 255 then --Ë÷ÒıÖµ·µ»Ø255±íÊ¾¿Õ£¬Ã»Ìá½»ÕäÊŞ
		...
		if petdataid == x250003_g_PetDataID then
			--½±Àø½ğÇ®²¢ÌáÊ¾
				...
				BeginEvent(sceneId)
					AddText(sceneId,"Nhi®m vø hoàn thành, t£ng cho các hÕ #{_MONEY"..x250003_g_MoneyBonus.."}")
				EndEvent(sceneId)
