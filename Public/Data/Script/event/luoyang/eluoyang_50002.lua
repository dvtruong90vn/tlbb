...
x250002_g_MissionTarget="Giúp Vân Hàm Nhi tìm ğßşc 1 con Th¯."		--ÈÎÎñÄ¿±ê
x250002_g_ContinueInfo="Các hÕ b¡t ğßşc Th¯ chßa?"		--Î´Nhi®m vø hoàn thành!µÄnpc¶Ô»°
x250002_g_MissionComplete="Làm t¯t l¡m."					--Nhi®m vø hoàn thành!npcËµ»°µÄ»°
	...
	if indexpet == 255 then --Ë÷ÒıÖµ·µ»Ø255±íÊ¾¿Õ£¬Ã»Ìá½»ÕäÊŞ
		...
		if petdataid == x250002_g_PetDataID then
			--½±Àø½ğÇ®²¢ÌáÊ¾
				...
				BeginEvent(sceneId)
					AddText(sceneId,"Nhi®m vø hoàn thành, t£ng cho các hÕ #{_MONEY"..x250002_g_MoneyBonus.."}")
				EndEvent(sceneId)
