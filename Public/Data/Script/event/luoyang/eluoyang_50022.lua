...
x250022_g_MissionTarget="Giúp Vân Hàm Nhi tìm ðßþc 1 con Bång T¢m."		--ÈÎÎñÄ¿±ê
x250022_g_ContinueInfo="Các hÕ b¡t ðßþc Bång T¢m ch½a?"		--Î´Nhi®m vø hoàn thành!µÄnpc¶Ô»°
x250022_g_MissionComplete="Làm t¯t l¡m."					--Nhi®m vø hoàn thành!npcËµ»°µÄ»°
	...
	if indexpet == 255 then --Ë÷ÒýÖµ·µ»Ø255±íÊ¾¿Õ£¬Ã»Ìá½»ÕäÊÞ
		...
		if petdataid == x250022_g_PetDataID then
			--½±Àø½ðÇ®²¢ÌáÊ¾
				...
				BeginEvent(sceneId)
					AddText(sceneId,"Nhi®m vø hoàn thành, t£ng cho các hÕ #{_MONEY"..x250022_g_MoneyBonus.."}")
				EndEvent(sceneId)
