...
x250011_g_MissionTarget="Giúp Vân Hàm Nhi tìm ðßþc 1 con H¥u TØ."		--ÈÎÎñÄ¿±ê
x250011_g_ContinueInfo="Các hÕ b¡t ðßþc H¥u TØ ch½a?"		--Î´Nhi®m vø hoàn thành!µÄnpc¶Ô»°
x250011_g_MissionComplete="Làm t¯t l¡m."					--Nhi®m vø hoàn thành!npcËµ»°µÄ»°
	...
	if indexpet == 255 then --Ë÷ÒýÖµ·µ»Ø255±íÊ¾¿Õ£¬Ã»Ìá½»ÕäÊÞ
		...
		if petdataid == x250011_g_PetDataID then
			--½±Àø½ðÇ®²¢ÌáÊ¾
				...
				BeginEvent(sceneId)
					AddText(sceneId,"Nhi®m vø hoàn thành, t£ng cho các hÕ #{_MONEY"..x250011_g_MoneyBonus.."}")
				EndEvent(sceneId)
