...
x210223_g_MissionTarget="V« #GNgû Hoa Ğàn thành ĞÕi Lı#W tìm ğªn #GTri®u Thiên Sß #W#{_INFOAIM282,253,2,Tri®u Thiên Sß}.#r#YNh¡c nh·: #G?n chuµt phäi vào t÷a ğµ NPC có th¬ tñ ğµng d¸ch chuy¬n ğªn ch² NPC ğó!"
...
x210223_g_SignPost = {x = 282, z = 253, tip = "Tri®u Thiên Sß"}
...
function x210223_OnAccept( sceneId, selfId )
	...
	Msg2Player(  sceneId, selfId,"#YNh§n nhi®m vø#W: Lá thß tiªn cØ thÑ 7",MSG2PLAYER_PARA )
		...
		--Ìí¼ÓÈÎÎñ½±Àø
			if ret > 0 then
				...
				if ret > 0 then
					...
					Msg2Player(  sceneId, selfId,"#YNhi®m vø hoàn thành#W: Lá thß tiªn cØ thÑ 7",MSG2PLAYER_PARA )
				end
			else
				--ÈÎÎñ½±ÀøÃ»ÓĞ¼Ó³É¹¦
				BeginEvent(sceneId)
