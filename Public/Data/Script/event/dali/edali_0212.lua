...
x210212_g_MissionTarget="V« #GNgû Hoa Ğàn thành ĞÕi Lı#W tìm #RTri®u Thiên Sß #W#{_INFOAIM282,253,2,Tri®u Thiên Sß}.#r#YNh¡c nh·: #G?n chuµt phäi vào t÷a ğµ NPC có th¬ tñ ğµng d¸ch chuy¬n ğªn ch² NPC ğó!"
x210212_g_MissionComplete="#{event_dali_0017}"
x210212_g_MoneyBonus=72
x210212_g_SignPost = {x = 282,z = 253, tip = "Tri®u Thiên Sß"}
...
function x210212_OnAccept( sceneId, selfId )
	...
	Msg2Player(  sceneId, selfId,"#YNh§n nhi®m vø#W: Lá thß tiªn cØ thÑ 3",MSG2PLAYER_PARA )
		...
		--Ìí¼ÓÈÎÎñ½±Àø
			if ret > 0 then
				...
				if ret > 0 then
					...
					Msg2Player(  sceneId, selfId,"#YNhi®m vø hoàn thành#W: Lá thß tiªn cØ thÑ 3",MSG2PLAYER_PARA )
				end
			else
				--ÈÎÎñ½±ÀøÃ»ÓĞ¼Ó³É¹¦
				BeginEvent(sceneId)
