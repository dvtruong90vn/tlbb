...
x210233_g_MissionTarget="Tìm ğßşc Nh¤t Ph¦m Nhu M­ và Nh¤t Ph¦m H°ng Ğ§u, sau ğó v« #GNgû Hoa Ğàn thành ĞÕi Lı#W tìm 1 trong TÑ ğÕi thi®n nhân #RLı Công Bµ #W#{_INFOAIM282,220,2,Lı Công Bµ}."		--ÈÎÎñÄ¿±ê
		...
		if ret > 0 then
			...
			if	ret > 0 then
				...
				if ret > 0 then
					...
					Msg2Player(  sceneId, selfId,"#YNhi®m vø hoàn thành#W: Ngñ TÑ Tinh Phöng MÕo",MSG2PLAYER_PARA )
				end
			else
				--É¾³ıÎïÆ·²»³É¹¦
				BeginEvent(sceneId)
